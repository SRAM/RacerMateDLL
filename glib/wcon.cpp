...
Console::Console(int _rows, int _cols, int _bgcolor)  {
	...
	*/
	...
	//SMALL_RECT r = {0, 1, 0, 1};				// left, top, right, bottom
...
void Console::scroll_area(SMALL_RECT _r, int count)  {
	...
	dest.X = _r.Left;
	dest.Y = _r.Top;
 	//clip_rect = _r;				// The clipping rectangle is the same as the scrolling rectangle. The destination row is left unchanged. 
