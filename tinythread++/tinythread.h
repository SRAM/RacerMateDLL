...
///
/// @section poec Portability
/// The Win32 variant usesrt_s the native Win32 API for implementing the thread
...
template <__intmax_t N, __intmax_t D = 1> class ratio {
  public:
	...
	// The namespace @c this_thread provides methods for dealing with the calling thread
