...
QT_MOC_LITERAL(1, 18, 15), // "worker_finished"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 5), // "start"
QT_MOC_LITERAL(4, 41, 4), // "stop"
QT_MOC_LITERAL(5, 46, 12) // "timeout_slot"

    },
    "RACERMATE::Worker\0worker_finished\0\0"
    "start\0stop\0timeout_slot"
};
...
void RACERMATE::Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::worker_finished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RACERMATE::Worker::worker_finished()
{
