...
#else
		int get_n_devices(void)  { return worker->devices.size(); }
		bool get_scanning_for_devices(void)  { return worker->scanning_for_devices; }
		bool is_listening(void)  { return worker->listening; }
#endif
